...
This document provides a comprehensive, step-by-step guide for deploying the **NUEVINCENT** creative studio website to **Netlify**, enabling automated continuous deployment via GitHub, setting up Netlify Forms email alerts, and connecting your custom domain.
...
1. In your Netlify Site Dashboard, go to **Site configuration** → **Forms**.
2. Scroll to **"Form notifications"** and click **"Add notification"** → **"Email notification"**.
...
- You will see the form named `nuevincent-enquiry` with all customer inquiries (Full Name, Company, Work Email, Phone/WhatsApp, Project Type, Budget Range, Target Timeline, Project Description, and more).
