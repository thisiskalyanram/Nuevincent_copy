    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          >
            <div className="relative w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-cinema-900/90 border border-white/10 p-1 flex items-center justify-center group-hover:border-brand-purple/50 group-hover:shadow-glow-purple transition-all">
              <Image
                src="/logo-icon.png"
                alt="NUEVINCENT Logo"
                width={40}
