...
export const PROJECTS: PortfolioProject[] = [
  {
    ...
    fullStory: "Shot over 9 chilly winter mornings across historic Deccan architecture and rugged landscapes, 'Echoes of Silence' is an exploration of silence as a narrative device. Using natural light and minimal artificial fixtures...",
  ...
  },
  {
    ...
    fullStory: "Designed for a global launch campaign, Aura Velocity showcases the raw dynamism of next-generation performance mobility. We orchestrated high-speed pursuit tracking on closed airport runways...",
  ...
  },
  {
    ...
    fullStory: "Shot in our studio with probe macro lenses, motorized micro-sliders, and precision fiber-optic lighting, this commercial accentuates the intricate tactile craftsmanship of luxury horology...",
  ...
  },
  {
    ...
    fullStory: "A blend of 16mm analog film grain, mixed frame rates (6fps step-printing to 120fps ultra-slow-mo), and hyper-saturated dual-tone lighting. The film establishes a distinct cultural narrative...",
  ...
  },
  {
    ...
    fullStory: "Created specifically for 9:16 high-engagement social platforms, this series achieved over 4.8 million organic impressions. Utilizing snappy whip-pans, rhythmic sound matches, and dynamic color grading...",
  ...
  },
  {
    ...
    fullStory: "Demonstrating the technical finesse of NUEVINCENT's dedicated post-production suite. Features split-screen slider breakdowns showing raw Log camera footage transformed into lush, cinematic masters...",
